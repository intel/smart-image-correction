...
def surfaceFmain(imgfile,F="SF-04"):
    ## imgfile means FileName
   ...
   # for imgfile in sys.argv[1:]:
    for i in range(1,2):
        ...
        outputImg = remap_image(name, img, small, page_dims, params)
