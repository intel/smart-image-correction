import numpy as np
from RemoveHandwritten.cut_text.text_proposal_connector import TextProposalConnector
from RemoveHandwritten.cut_text.image import rotate_nms, nms, get_boxes
